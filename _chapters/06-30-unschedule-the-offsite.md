...
categories:
  ...
  - implementation
seo:
  description: Don't pack the offsite with meetings. The value of in-person time is in the margins - dinners, walks, unexpected conversations. You can do work anytime. You can only build relationships when together.
